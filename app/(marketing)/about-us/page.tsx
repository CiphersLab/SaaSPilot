...
const Page = async () => {
  return (
    <>    
      <MaxWidthWrapper className="mb-8 mt-24 max-w-5xl">
        <>
          <div className="pb-16 text-center">
            <h1 className="mb-4 text-3xl font-bold -tracking-[1px]">
              About Us
            </h1>
            <ul className="flex items-center justify-center gap-2">
              <li>
                <Link href="/landing-page-1">Home</Link>
              </li>
      ...
      <div className="bg-secondary pb-8 pt-20 dark:bg-dark-2 lg:pb-[70px] lg:pt-[120px]">
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 max-w-[540px] lg:mb-0">
                ...
                <p className="mb-10 text-base leading-relaxed text-muted-foreground dark:text-dark-6">
                ...
                <a
                  className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 px-7 py-3"
                >
                  Know More
                </a>
              </div>
        ...
        <div className="container">
          <div className="mb-[60px]">
            <div className="-mx-4 flex flex-wrap">
              <div className="wow fadeInUp w-full px-4 mx-auto text-center">
                ...
                <p className="text-base leading-relaxed text-muted-foreground dark:text-dark-6 sm:leading-relaxed">
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
              <div className="shadow-testimonial dark:bg-dark group mb-8 rounded-xl border px-5 pb-10 pt-12 dark:shadow-none">
                <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                  <img
                    className="w-full w-[120px] h-[120px] max-w-[120px] max-h-[120px] object-contain rounded-full"
