  ...
  return (
    <>    
      <MaxWidthWrapper className="mb-8 mt-24 max-w-5xl">
        <>
          <div className="pb-16 text-center">
            <h1 className="mb-4 text-3xl font-bold -tracking-[1px]">Contact Us</h1>
      ...
      <div className="relative py-20 md:py-[120px]">
        ...
        <div className="absolute left-0 top-0 -z-[1] h-1/2 w-full bg-secondary dark:bg-dark-700 lg:h-[45%] xl:h-1/2"></div>
        <div className="container px-4">
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
              <div className="rounded-lg bg-background border px-8 py-10 shadow-testimonial dark:bg-dark-2 dark:shadow-none sm:px-10 sm:py-12 md:p-[60px] lg:p-10 lg:px-10 lg:py-12 2xl:p-[60px]">
                ...
                <form>
                  ...
                  <div className="mb-0">
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-9 px-10 py-3"
                    >
                      Send
                    </button>
                  </div>
